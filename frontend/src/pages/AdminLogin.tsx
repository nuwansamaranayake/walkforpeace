...
import { adminLogin, changePassword } from '../services/api'
  ...
  return (
    <div className="min-h-screen bg-navy flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-sm w-full">
        ...
        {mustChange ? (
          <form onSubmit={handleChangePassword}>
            ...
            <input type="password" placeholder="New password (min 8 chars)" value={newPwd}
              ...
              className="w-full border rounded-lg px-3 py-2 mb-4 focus:ring-2 focus:ring-saffron" />
          ...
          <form onSubmit={handleLogin}>
            <input type="text" placeholder="Username" value={username}
              ...
              className="w-full border rounded-lg px-3 py-2 mb-3 focus:ring-2 focus:ring-saffron" />
        ...
        <Link to="/" className="block text-center text-sm text-gray-400 mt-4 hover:text-saffron">← Back to home</Link>
      </div>
    </div>
  )
}
